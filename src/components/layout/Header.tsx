...
export function Header() {
  ...
  return (
    ...
    >
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg flex flex-col p-4 gap-4">
          {menuItems.map(({ href, label, target, isFeatured }) => (
            <Link
              ...
              className={`
                text-lg text-gray-600 transition-colors duration-300
